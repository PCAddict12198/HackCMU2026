...
| `agent/data-dishes` | **data-dishes** (helper agent for extended-tier dishes, e.g. Cursor/Codex) | `docs/agents/data-dishes.md` |
...
- **data**: `data/**` (except `data/sanity/**`, frozen, and `data/dishes/extended/**`), `tools/data/**`, `docs/demo/**`, `docs/handoffs/data.md`
- **data-dishes** (helper): `data/dishes/extended/<cuisine>.yaml`, `docs/handoffs/data-dishes.md`
